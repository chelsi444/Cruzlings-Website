          ...
          <div className="rounded-3xl bg-card ring-1 ring-border shadow-xl p-6 sm:p-12">
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-8">
                {[
                  { name: "Jayden Luu", role: "CEO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202026-04-16%20at%204.12.07%E2%80%AFPM-JfiOct7BJkPCuAiGb6CQAeIUJLZ4XW.png", bio: "Jayden is a first-year Technology and Information Management student. He enjoys tennis, football, basketball, and spikeball.", rotate: false },
