...
export default function HomePage() {
  ...
  const execMembers: Member[] = [
    { name: "Surabhi Kuchibhotla", role: "CEO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-QetsM8Ww8WFw1Pe7QNYdI9rtKShpVN.png", bio: "Surabhi Kuchibhotla is a third-year TIM major. She enjoys going to the gym, hiking, and swimming at the beach." },
    { name: "Kyle Bradford", role: "CFO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-bxQMOuHVseWpvXVUfU1ILNyCGdq3zA.png", bio: "Kyle Bradford is a first-year Business Management and Economics and Legal Studies student. He enjoys tennis, video games, and soccer." },
    { name: "Chelsi Vaghela", role: "CTO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SAM_0346-dUGNKhySHTtqBLiS1ynuv00rZwkcVg.jpg", bio: "Chelsi Vaghela is a first-year Computer Science and Game Design major. She enjoys soccer, running, and hiking." },
    ...
    { name: "Jayden Luu", role: "PR", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202026-04-16%20at%204.12.07%E2%80%AFPM-JfiOct7BJkPCuAiGb6CQAeIUJLZ4XW.png", bio: "Jayden Luu is a first-year TIM major. He enjoys tennis, football, basketball, and spikeball." },
    { name: "Rebecca Abraham", role: "Secretary", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-HNo9A5RtbF42GIGPo9atJeWrM0mFWe.png", bio: "Rebecca Abraham is a second-year Biomolecular Engineering and Bioinformatics major. She enjoys soccer, going to the beach, and going on drives." },
  ]

  const regularMembers: Member[] = [
    { name: "Sahasra Chada", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-i3x4jch72QxWk8iSBvMLPCM0ALqDrH.png", bio: "Sahasra Chada is a first-year Biomolecular Engineering and Bioinformatics major. She enjoys badminton, henna, music, going to the beach, and exploring downtown." },
    { name: "Haatim Ali", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-1Wx6bqjxa0WHMso3cqmHwIcCbYAbXO.png", bio: "Haatim Ali is a first-year Computer Science major. He enjoys soccer, hiking, and watching anime." },
    { name: "Eobii Brown", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-MN8Ct7WKXWYD6iLVfK4GdN597wcTGr.png", bio: "Eobii Brown is a second-year Business Management and Economics student. He enjoys tennis, basketball, and gaming." },
    ...
    { name: "Adam Lee", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-CmpDb42N1s9J5zTct9u8LG98n4uJQX.png", bio: "Adam Lee is a second-year Business Management and Economics student. He enjoys going to the gym, playing basketball, gaming, and hiking." },
    { name: "Chintan Patwardhan", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-TwWOvcPMprlkf9qpizrPpyMGClJ8Ar.png", bio: "Chintan Patwardhan is a first-year Robotics Engineer student. He enjoys soccer, skiing, and skateboarding." },
    ...
    { name: "Iryna Monastyrska", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-dhCGQcZR9VMPX9u9JLX2m8UBOzSimj.png", bio: "Iryna Monastyrska is a second-year Business Management and Economics student. She enjoys sewing, thrifting, and collecting magnets." },
  ]
