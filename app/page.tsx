            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                {[
                  ...
                  { name: "Kyle Bradford", role: "CFO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image.png-dEp8NIxlxWA1I4sJBB7zTi77KXVfC8.jpeg", bio: "Kyle is a first-year Business Management and Economics student. He enjoys tennis, video games, and soccer." },
