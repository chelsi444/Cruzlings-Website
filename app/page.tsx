  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative min-h-screen overflow-hidden pt-20">
        ...
        {/* Realistic Flower - Left side */}
        <div className="absolute bottom-32 left-8 md:left-16 z-5">
          <svg width="80" height="120" viewBox="0 0 80 120">
            {/* Stem */}
            <path d="M40,120 Q38,90 40,60" stroke="#3d6b3d" strokeWidth="3" fill="none" />
            {/* Leaves on stem */}
            <path d="M40,100 Q25,95 20,85 Q30,90 40,95" fill="#5a8a5a" />
            <path d="M40,85 Q55,80 60,70 Q50,75 40,80" fill="#5a8a5a" />
            {/* Flower petals - realistic rose shape */}
            <ellipse cx="40" cy="45" rx="18" ry="12" fill="#e88a8a" transform="rotate(-20, 40, 45)" />
            <ellipse cx="40" cy="45" rx="18" ry="12" fill="#e07070" transform="rotate(20, 40, 45)" />
            <ellipse cx="40" cy="45" rx="18" ry="12" fill="#d85858" transform="rotate(60, 40, 45)" />
            <ellipse cx="40" cy="45" rx="18" ry="12" fill="#e88a8a" transform="rotate(-60, 40, 45)" />
            <ellipse cx="40" cy="45" rx="18" ry="12" fill="#e07070" transform="rotate(100, 40, 45)" />
            <circle cx="40" cy="45" r="8" fill="#d4a040" />
          </svg>
        </div>

        {/* Realistic Sunflower - Right side */}
        <div className="absolute top-40 right-8 md:right-16 z-5 hidden md:block">
          <svg width="100" height="140" viewBox="0 0 100 140">
            {/* Stem */}
            <path d="M50,140 Q48,110 50,70" stroke="#3d6b3d" strokeWidth="4" fill="none" />
            {/* Large leaf */}
            <path d="M50,120 Q30,110 15,100 Q25,115 50,115" fill="#5a8a5a" />
            <path d="M50,105 Q70,95 85,85 Q75,100 50,100" fill="#4d7a4d" />
            {/* Sunflower petals */}
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#f4d03f" transform="rotate(0, 50, 40)" />
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#e8c430" transform="rotate(30, 50, 40)" />
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#f4d03f" transform="rotate(60, 50, 40)" />
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#e8c430" transform="rotate(90, 50, 40)" />
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#f4d03f" transform="rotate(120, 50, 40)" />
            <ellipse cx="50" cy="40" rx="8" ry="20" fill="#e8c430" transform="rotate(150, 50, 40)" />
            {/* Center */}
            <circle cx="50" cy="40" r="15" fill="#8B4513" />
            <circle cx="47" cy="37" r="2" fill="#5a3510" />
            <circle cx="53" cy="37" r="2" fill="#5a3510" />
            <circle cx="50" cy="43" r="2" fill="#5a3510" />
            <circle cx="44" cy="41" r="1.5" fill="#5a3510" />
            <circle cx="56" cy="41" r="1.5" fill="#5a3510" />
          </svg>
        </div>

        {/* Realistic Tulip - Left bottom */}
        <div className="absolute bottom-48 left-32 md:left-48 z-5 hidden md:block">
          <svg width="60" height="100" viewBox="0 0 60 100">
            {/* Stem */}
            <path d="M30,100 L30,45" stroke="#3d6b3d" strokeWidth="3" fill="none" />
            {/* Leaf */}
            <path d="M30,90 Q15,80 10,60 Q20,75 30,85" fill="#5a8a5a" />
            {/* Tulip petals */}
            <path d="M30,45 Q20,30 22,15 Q30,25 30,45" fill="#c86464" />
            <path d="M30,45 Q40,30 38,15 Q30,25 30,45" fill="#b85454" />
            <path d="M30,45 Q25,28 30,10 Q35,28 30,45" fill="#d87474" />
          </svg>
        </div>

        {/* Butterfly */}
        <div className="absolute top-48 left-1/4 z-5 animate-pulse hidden lg:block">
          <svg width="40" height="30" viewBox="0 0 40 30">
            <ellipse cx="20" cy="15" rx="2" ry="8" fill="#333" />
            <ellipse cx="12" cy="12" rx="8" ry="6" fill="#e8a0c8" opacity="0.8" />
            <ellipse cx="28" cy="12" rx="8" ry="6" fill="#e8a0c8" opacity="0.8" />
            <ellipse cx="10" cy="20" rx="5" ry="4" fill="#c888a8" opacity="0.7" />
            <ellipse cx="30" cy="20" rx="5" ry="4" fill="#c888a8" opacity="0.7" />
            <circle cx="12" cy="12" r="2" fill="#fff" opacity="0.5" />
            <circle cx="28" cy="12" r="2" fill="#fff" opacity="0.5" />
          </svg>
        </div>
