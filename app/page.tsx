...
export default function HomePage() {
  ...
  const events = [
    ...
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_5278-VWXvaUMDVHyKAzQuXYPzCNVcsQ42FJ.jpeg",
      title: "Banh Mi Fundraiser",
    ...
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_2543-Ah0Pt3OsXudHK31MpHsmzYpcKMpkES.jpg",
    ...
    {
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_7320-s80DxXxPiCi4A26rClJE6sVQhBL56f.jpg",
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 rounded-2xl bg-secondary ring-1 ring-border overflow-hidden shadow-lg flex flex-col">
                ...
                <div className="p-5 sm:p-6 flex flex-col flex-1">
                  <h4 className="text-lg sm:text-xl font-semibold text-foreground mb-3">{currentEvent.title}</h4>
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
                {[
                  ...
                  { name: "Chintan Patwardhan", role: "CTO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-TwWOvcPMprlkf9qpizrPpyMGClJ8Ar.png", bio: "Chintan is a first-year Robotics Engineering student. He enjoys soccer, skiing, and skateboarding." },
                  { name: "Iryna Monastyrska", role: "CMO", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-dhCGQcZR9VMPX9u9JLX2m8UBOzSimj.png", bio: "Iryna is a second-year Business Management and Economics student with a concentration in Accounting. She enjoys sewing." },
                  { name: "Chelsi Vaghela", role: "PR", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-7QaKbRjfEvyUKgCXPKzCN08ejkUCcp.png", bio: "Chelsi is a first-year Computer Science and Game Design student. She enjoys soccer, running, and hiking." },
                  { name: "Sanika Yadav", role: "Secretary", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-yIlFYbaN1nVv78P3JoT5jkL37kaAnc.png", bio: "Sanika is a first-year Business Management and Economics student. She enjoys dancing, listening to music, going to the beach, and anything adventurous." },
                ].map((member, index) => (
                  <div
                    key={index}
